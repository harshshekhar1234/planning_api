...
function ScheduleDept() {
  ...
  <header className="bg-center cover " style={{ 
      backgroundImage: `url(${img_url}tribal.jpg)` 
    }}>
    <div className="mw9 center pa4 pt5-ns ph7-l">
      <h3 className="f2 f1-ns measure-narrow lh-title mv0">
        <span className="bg-black-90 lh-copy white pa1 tracked-tight">
        Schedule Tribe, Schedule Caste, Minority and Backward Class Welfare
        </span>
      </h3>
    </div>
  </header>
  <div className="pa4 ph7-l georgia mw9-l center">
      <p className="f5 f3-ns lh-copy georgia">
        This department is mandated to look after the welfare of the most underprivileged sections of the society namely the Schedule Tribes, Scheduled Castes, Backward classes and Minorities and the task of bringing all round development of these sections. 
      </p>
