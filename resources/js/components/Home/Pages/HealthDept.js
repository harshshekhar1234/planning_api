...
function HealthDept() {
  ...
  <header className="bg-center cover " style={{ 
      backgroundImage: `url(${img_url}healthcare.jpg)` 
    }}>
  ...
  <div className="pa4 ph7-l georgia mw9-l center">
    ...
    Gender and human rights issues to disadvantaged groups and adolescents would be given highest priority, with the aim of eliminating discrimination in the provision of health care at all levels and in all sectors.
  </p>
