...
function SocialSecurity() {
  ...
  <header className="bg-center cover " style={{ 
      backgroundImage: `url(${img_url}image6.jpg)` 
    }}>
  ...
  <div className="pa4 ph7-l georgia mw9-l center">
    ...
    After the partition from the state of Bihar on 15 Nov 2000, the Jharkhand state government has introduced Lakshmi LadliYojna ,Anganabadi Nursery School, JeevanAshaYojnaand many more.
  </p>
