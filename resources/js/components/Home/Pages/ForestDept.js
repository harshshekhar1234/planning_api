...
function ForestDept() {
  ...
  <header className="bg-center cover " style={{ 
      backgroundImage: `url(${img_url}forest.jpg)` 
    }}>
  ...
  <div className="pa4 ph7-l georgia mw9-l center">
      <p className="f5 f3-ns lh-copy georgia">
        The state of Jharkhand has a unique relation with forest since ancient times. The word ‘Jharkhand' connotes ‘area of land covered with forests'. Therefore, literally as well as symbolically, Jharkhand is associated with forests.
      </p>
