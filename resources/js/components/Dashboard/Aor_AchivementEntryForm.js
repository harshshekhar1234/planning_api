...
import {getOutlayData,aorstoreFinancialData,aorgetFinancialData,aorupdateFinancialData} from '../store/outlay-actions';
...
import {aorgetSubSchemesHeaderReport} from '../store/subschemes-actions';
...
import {
  ...
  aorgetAchievementsOutputData,
  aorstoreOutputAchievementData,
  aorgetAchievementsOutcomeData,
  aorstoreOutcomeAchievementData,
  aorgetRiskRemarksData,
  aorstoreRiskRemarksData,
  aorupdateOutputAchievementData,
  aorupdateOutcomeAchievementData
...
function AorAchievementEntryForm() {
  ...
  useEffect(() => {
    dispatch(aorgetAchievementsOutputData(params.id));
    }, [updateoutputedit]);

  useEffect(() => {
    dispatch(aorgetAchievementsOutcomeData(params.id));
    }, [updateoutcomeedit]);
...
useEffect(() => {
    if(updateOutlay){
      dispatch(aorgetSubSchemesHeaderReport(params.id));
    }
    }, [updateOutlay]);
  ...
  useEffect(() => {
    ...
    const handleOpen1 = (indicator) => {
      setOutputAddBtn(indicator.aor_add_btn_flag)
      setOpen1(true)
    ...
    const handleOpen3 = (indicator) => {
      setOutcomeAddBtn(indicator.aor_add_btn_flag)
      setOpen3(true)
    ...
    const handleOpen5 = (id) => {
      ...
      dispatch(aorgetFinancialData(params.id));
    };
    ...
    useEffect(() => {
        ...
        dispatch(aorgetSubSchemesHeaderReport(params.id));
        dispatch(aorgetRiskRemarksData(params.id));
    ...
    const onSubmitAchievementEdit = () => {
      ...
      dispatch(aorupdateOutputAchievementData(outputAchIdEdit,valueEdit,timeEdit));
    ...
    const onSubmitOutcomeAchievementEdit = () => {
      ...
      dispatch(aorupdateOutcomeAchievementData(outcomeAchIdEdit,valueoutcomeEdit,timeoutcomeEdit));
    ...
    const onSubmitAchievement = (departmentId,divisionId,schemeId,subschemeId,outputId,outputindicatorId,valueTarget) => {
      ...
      dispatch(aorstoreOutputAchievementData(departmentId,divisionId,schemeId,subschemeId,outputId,outputindicatorId,value,time));
    ...
    const onSubmitFinancial = (id) => {
      ...
      dispatch(aorstoreFinancialData(sanctioned,allotment,expenditure,outlaytime,id));
      handleClose5();
    }
    ...
    const onSubmitAchievementOutcome = (departmentId,divisionId,schemeId,subschemeId,outcomeId,outcomeindicatorId,valueTarget) => {
      ...
      dispatch(aorstoreOutcomeAchievementData(departmentId,divisionId,schemeId,subschemeId,outcomeId,outcomeindicatorId,valueoutcome,timeoutcome));
    ...
    const onSubmitRemarks = (id) => {
      ...
      dispatch(aorstoreRiskRemarksData(a,id));
      setRiskRemarksEdit('')
      handleClose7();
    }
  ...
  <Snackbar open={financialentrynotificationsuccess} autoHideDuration={4000} onClose={handleCloseFinancialSuccess}>
    ...
    <input id="name" className="ba b--black-80 pa2 mb2 db w-100 bg-transparent" type="text" aria-describedby="name-desc" value={time.slice(0,10)}/>
    ...
    <label htmlFor="name" className="f6 b db mb2 nunito">Achievement Entered On</label>
    <input id="name" className="ba b--black-80 pa2 mb2 db w-100 bg-transparent" type="text" aria-describedby="name-desc" value={timeEdit.slice(0,10)}/>
    <small id="name-desc" className="f6 black-60 db mb2">Enter Achievement for current year</small>
    ...
    <label htmlFor="name" className="f6 b db mb2 nunito">Achievement Entered On</label>
    <input id="name" className="ba b--black-80 pa2 mb2 db w-100 bg-transparent" type="text" aria-describedby="name-desc" value={timeoutcomeEdit.slice(0,10)}/>
    <small id="name-desc" className="f6 black-60 db mb2">Enter Achievement for current year</small>
    ...
    <label htmlFor="name" className="f6 b db mb2 nunito">Achievement Entered On</label>
    <input id="name" className="ba b--black-80 pa2 mb2 db w-100 bg-transparent" type="text" aria-describedby="name-desc" value={timeoutcome.slice(0,10)}/>
    <small id="name-desc" className="f6 black-60 db mb2">Enter Achievement for current year</small>
  ...
  <div className="overflow-auto">
    <table className="f6 w-100 mw8 center " cellSpacing="0">
      ...
      {achlists && achlists.map(achlist => {
        return (<tr>
          <td className="pv3 pr3  b--black-80 tc">{achlist.time.slice(0,10)}</td>
  ...
  <h3 className='b f5'>No Achievement Entered for this indicator</h3>
    ...
    <input id="time" className="ba b--black-80 pa2 mb2 db w-100 bg-transparent" type="text" aria-describedby="name-desc" value={outlaytime.slice(0,10)}/>
  ...
  <h3 className='b f5'>No Financial Entry made</h3>
      ...
      <h1 className='b'>Dashboard for submission of sub-schemes details for On Demand Report</h1>
...
export default AorAchievementEntryForm