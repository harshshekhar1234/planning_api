...
import {miggetSubSchemesDataDeptUser,migupdateSubSchemeData,migdeleteSubSchemeData} from '../store/subschemes-actions';
...
function IndicatorEditSubSchemeListDeptUser() {
  ...
  const handleActionClick = (id) => {
      ...
      return navigate(`/dashboarddeptuser/entryformdeptuser/${id}`);
  }
...
export default IndicatorEditSubSchemeListDeptUser
