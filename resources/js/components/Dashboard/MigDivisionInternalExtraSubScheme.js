...
function MigDivisionExtraSubSchemeListInternal() {
  ...
  return (<> 
    <div className='mh1 mh4-m mh5-ns br3'>
        ...
        <Link to={`/dashboard/migsubschemeinternalextra/${division.id}`} className='no-underline' style={{ textDecoration: 'none' }}>
...
export default MigDivisionExtraSubSchemeListInternal