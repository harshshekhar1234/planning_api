...
function MigrationDivisionReportDownload({id, name}) {
  ...
  return (<> 
    <div className='mh1 mh4-m mh5-ns br3'>
        ...
        <Link to={`/dashboard/migrationoutcomebudget/${division.id}`} className='no-underline' style={{ textDecoration: 'none' }}>
    <article className="dt w-100 bb b--black-20 pb2 mt2">
      ...
      <div className="dtc v-mid">
        <div className="w-100 tr">
          <button className="f6 button-reset bg-white ba b--black-10 dim pointer pv1 black-60">+ Download</button>
        </div>
      </div>
    </article>
    </Link>
...
export default MigrationDivisionReportDownload