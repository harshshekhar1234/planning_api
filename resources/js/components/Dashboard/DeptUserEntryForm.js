...
import {searchSubSchemesName,searchSubSchemesCode,miggetSubSchemesHeaderReport} from '../store/subschemes-actions';
import {miggetSearchOutputData,migupdateOutputData,migdeleteOutputData} from '../store/output-actions';
import {getSocialData, miggetSocialSubschemeData,migupdateSocialData} from '../store/social-actions';
import {getGenderData, miggetGenderSubschemeData,migupdateGenderData} from '../store/gender-actions';
import {getSdgsubschemeData,miggetSdgData,migupdateSdg} from '../store/sdgsubscheme-actions';
import {miggetSearchOutcomeData,migupdateOutcomeData,migdeleteOutcomeData} from '../store/outcome-actions';
import {miggetOutputTargetData} from '../store/outputtarget-actions';
import {miggetOutcomeTargetData} from '../store/outcometarget-actions';
import {miggetOutputIndicatorsData,migdeleteOutputIndicatorData} from '../store/outputindicator-actions';
import {miggetOutcomeIndicatorsData,migdeleteOutcomeIndicatorData} from '../store/outcomeindicator-actions';
import {miggetOutlayShareData,migupdateStateCenterData} from '../store/outlay-actions';
import {migstoreNewOutputData,
  migstoreNewOutputIndicatorData,
  migstoreNewOutcomeData,
  migstoreNewOutcomeIndicatorData,
  miggetOutputIndicatorEditData,
  miggetOutcomeIndicatorEditData,
  migupdateOutputIndicatorData,
  migupdateOutcomeIndicatorData,
  miggetRiskRemarksData,
  migstoreRiskRemarksData
...
const DeptUserEntryForm = () => {
    ...
    const updateriskremarks = useSelector((state) => state.deptuserentry.riskremarks);
    const entrymessageriskremarks = useSelector((state) => state.deptuserentry.entrymessageriskremarks);
    ...
    const updateRemarkSuccess = useSelector((state) => state.deptuserentry.updateRemarkSuccess);
    ...
    useEffect(() => {
      dispatch(miggetSdgData(params.id))
      dispatch(miggetSearchOutputData(params.id))
      dispatch(miggetSearchOutcomeData(params.id))
      dispatch(miggetSocialSubschemeData(params.id))
      dispatch(miggetGenderSubschemeData(params.id))
      dispatch(miggetSubSchemesHeaderReport(params.id))
      dispatch(miggetOutlayShareData(params.id))
      dispatch(miggetRiskRemarksData(params.id));
      return () => {
        ...
        dispatch(deptUserEntryActions.setRiskRemarks({riskremarks: ''}))
        dispatch(deptUserEntryActions.setUpdateRemarkSuccess({updateRemarkSuccess:false}))
    ...
    useEffect(() => {
        ...
        dispatch(miggetSearchOutputData(subSchemeSearchResult.id))
        dispatch(miggetSearchOutcomeData(subSchemeSearchResult.id))
        dispatch(miggetSocialSubschemeData(subSchemeSearchResult.id))
        dispatch(miggetGenderSubschemeData(subSchemeSearchResult.id))
      }
      ...
      const handleOutputIndicatorEditSubmit = () => {
        ...
        dispatch(migupdateOutputIndicatorData(outputindicatoredit,outputindicatortargetedit))
        handleClose8()
      ...
      const handleOutcomeIndicatorEditSubmit = () => {
        ...
        dispatch(migupdateOutcomeIndicatorData(outcomeindicatoredit,outcomeindicatortargetedit))
        handleClose9()
      ...
      const handleSDGEdit = () => {
        dispatch(migupdateSdg(params.id,sdgEdit,sdgEditName))
        handleClose7()
      }
    ...
    const handleOpen8 = (id) => {
      ...
      setOpen8(true)
      handleClose2()
      dispatch(miggetOutputIndicatorEditData(id))
    ...
    const handleOutputDelete = () => {
      dispatch(migdeleteOutputData(outputDeleteId))
      handleClose17()
    }
    ...
    const handleOutputIndicatorDelete = () => {
      dispatch(migdeleteOutputIndicatorData(outputIndicatorDeleteId))
      handleClose15()
    }
    ...
    const handleOutcomeDelete = () => {
      dispatch(migdeleteOutcomeData(outcomeDeleteId))
      handleClose18()
    }
    ...
    const handleOutcomeIndicatorDelete = () => {
      dispatch(migdeleteOutcomeIndicatorData(outcomeIndicatorDeleteId))
      handleClose16()
    }
    ...
    const handleOpen9 = (id) => {
      ...
      setOpen9(true)
      handleClose5()
      dispatch(miggetOutcomeIndicatorEditData(id))
    ...
    const handleOpen2 = (id) => {
      setOpen2(true)
      dispatch(miggetOutputIndicatorsData(id))
      dispatch(miggetOutputTargetData(id))
    ...
    const handleOpen5 = (id) => {
      setOpen5(true)
      dispatch(miggetOutcomeIndicatorsData(id))
      dispatch(miggetOutcomeTargetData(id))
    ...
    const handleUpdateSocial = () => {
      ...
      dispatch(migupdateSocialData(params.id,editSocial))
      handleClose10()
    }
    ...
    const handleUpdateGender = () => {
      ...
      dispatch(migupdateGenderData(params.id,editGender))
      handleClose11()
    }
    ...
    const handleUpdateOutput = () => {
      ...
      dispatch(migupdateOutputData(editOutputId,editOutput))
      handleClose13()
    }
    ...
    const handleUpdateOutcome = () => {
      ...
      dispatch(migupdateOutcomeData(editOutcomeId,editOutcome))
      handleClose14()
    }
    ...
    const handleUpdateOutlay = () => {
      ...
      dispatch(migupdateStateCenterData(params.id,parseFloat(editStateShare),parseFloat(editCenterShare)))
      handleClose12()
    }
    ...
    const handleNewOutputSubmit = () => {
      ...
      dispatch(migstoreNewOutputData(output,outputIndicatorRows))
      handleClose1()
    ...
    const handleNewOutcomeSubmit = () => {
      ...
      dispatch(migstoreNewOutcomeData(outcome,outcomeIndicatorRows))
      handleClose4()
    ...
    const handleNewOutputIndicatorSubmit = () => {
      ...
      dispatch(migstoreNewOutputIndicatorData(output,outputIndicatorRows))
      handleClose3()
    }
    ...
    const handleNewOutcomeIndicatorSubmit = () => {
      ...
      dispatch(migstoreNewOutcomeIndicatorData(outcome,outcomeIndicatorRows))
      handleClose6()
    }
    ...
    const handleClose19 = () => {
      dispatch(deptUserEntryActions.setRiskRemarksEntryMessage({entrymessageriskremarks:''}))
      setOpen19(false)
    };
    ...
    const onSubmitRemarks = (id) => {
      ...
      if(riskremarksedit.length >= 2000){
        dispatch(deptUserEntryActions.setRiskRemarksEntryMessage({entrymessageriskremarks: 'Maximum characters allowed is 2000'}))
        return
      }
      if(riskremarksedit.length === 0){
        a = '-'
      }
      dispatch(migstoreRiskRemarksData(a,id));
      setRiskRemarksEdit('')
      handleClose19();
    }
    ...
    <Snackbar open={newoutputnotificationsuccess} autoHideDuration={4000} onClose={handleCloseNewOutputNotificationSuccess}>
      ...
      >
        <Box sx={style3}>
          ...
          />  
          {riskremarksedit && <p className="f6 ph3 pv2 mb2 mt2 black w-40 tc pointer b nunito">{`Characters Remaining: ${((2000 - riskremarksedit.length) > 0) ? (2000 - riskremarksedit.length) : '2000 characters count exceeded'}`}</p>}
...
<div>
<label htmlFor="exampleDataList" className="f5 b db mb2 mt2">Risk/Remarks</label>
              <div className="pa4">
...
export default DeptUserEntryForm
