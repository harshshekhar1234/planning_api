...
import {miggetSchemesDeptData,migupdateSchemeData,migdeleteSchemeData} from '../store/schemes-action';
...
function IndicatorEditSchemeListDeptUser() {
  ...
  return (
    ...
    <div className='pa2'>
    <p className="f6 link dim br3 ph3 pv2 mb2 dib mt2 white bg-dark-green w5 tc pointer" onClick={handleCreateScheme}>+ Create New Scheme</p>  
    </div>
...
export default IndicatorEditSchemeListDeptUser
