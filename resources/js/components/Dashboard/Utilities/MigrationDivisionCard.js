...
function MigrationDivisionCard({division}) {
  return (
    <article className="center mw5 mw5-ns w-100 w-25-ns ba mv4 shadow-2 br3">
    <Link to={`/dashboard/migrationdivision/${division.id}`} className='no-underline' style={{ textDecoration: 'none' }}>
...
export default MigrationDivisionCard