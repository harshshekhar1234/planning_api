...
import {miggetPendingSubSchemesData,migupdateSubSchemeData,migdeleteSubSchemeData} from '../store/subschemes-actions';
...
function PendingSubScheme() {
  ...
  useEffect(() => {
    dispatch(miggetPendingSubSchemesData(params.id))
    return () => {
...
export default PendingSubScheme
