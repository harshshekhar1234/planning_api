...
import {miggetSummaryDeptDataAdmin} from '../store/migration-actions';
...
function MigrationSummaryDivisionAdmin() {
  ...
  useEffect(() => {
    dispatch(miggetSummaryDeptDataAdmin(params.id));
...
export default MigrationSummaryDivisionAdmin