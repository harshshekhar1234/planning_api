...
import {miggetExtraSchemesData,migupdateSchemeData,migdeleteSchemeData} from '../store/schemes-action';
...
function MigDivisionExtraSchemeInternal() {
    ...
    useEffect(() => {
        dispatch(miggetExtraSchemesData(params.id));  
    ...
    useEffect(() => {
        ...
        const handleActionClick = (id) => {
            ...
            return navigate(`/dashboard/migsubschemeinternal/${id}`);
      }
...
export default MigDivisionExtraSchemeInternal