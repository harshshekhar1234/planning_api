...
import {getSubSchemesReport,getSubSchemesHeaderReport} from '../store/subschemes-actions';
...
function SubScheme() {
  ...
  useEffect(() => {
    dispatch(getSubSchemesReport(params.id));
  ...
  return (
    ...
    <table className="f6 w-100 center mb3 ba" cellSpacing="0">
      <tr style={{"borderWidth":"1px", 'borderColor':"#000000", 'borderStyle':'solid', textAlign:"center"}}>
        <td colSpan='15' style={{"borderWidth":"1px", 'borderColor':"#000000", 'borderStyle':'solid', textAlign:"center", fontWeight: 'bold'}}>{`Detailed Report ( As on ${new Date().toLocaleDateString({},
