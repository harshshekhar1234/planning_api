...
import {getSubSchemesData,updateSubSchemeData,deleteSubSchemeData} from '../store/subschemes-actions';
...
function SchemeEntry() {
    ...
    const handleActionClick = (id) => {
      ...
      dispatch(divisionsActions.setDivisionId({divisionId: subschemeselected[0].division_id}))
      dispatch(departmentActions.setDepartmentId({departmentId: subschemeselected[0].department_id}))
    
        return navigate(`/dashboard/admindataentry/${id}`);
    }
  ...
  const [open18, setOpen18] = React.useState(false);
    ...
    const handleSubSchemeDelete = () => {
      dispatch(deleteSubSchemeData(deleteSubSchemeId))
      handleClose18()
    }
  ...
  const onSubmitUpdateSubScheme = () => {
    ...
    dispatch(updateSubSchemeData(editSubSchemeId,editSubSchemeName,editSubSchemeCode));
    handleClose1()
  ...
  <Snackbar open={editNotificationSuccess} autoHideDuration={4000} onClose={handleEditSubSchemeNotificationSuccess}>
    ...
    <p className="f6 link dim br3 ph3 pv2 mb2 mt2 white bg-dark-green w5 tc pointer" onClick={onSubmitUpdateSubScheme}>Update</p>
      ...
      <p className="f6 link dim br3 ph3 pv2 mb2 dib mt2 white bg-dark-green w5 tc pointer" onClick={handleCreateSubScheme}>+ Create New Sub-Scheme</p>
