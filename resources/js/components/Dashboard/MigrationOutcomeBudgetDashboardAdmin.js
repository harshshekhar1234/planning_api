...
import {miggetSubSchemesDivisionReportAdmin} from '../store/divisions-action';
...
function MigrationOutcomeBudgetDashboardAdmin() {
  ...
  useEffect(() => {
    dispatch(miggetSubSchemesDivisionReportAdmin(params.id));
    return () => {
...
export default MigrationOutcomeBudgetDashboardAdmin