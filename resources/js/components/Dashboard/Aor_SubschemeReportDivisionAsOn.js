...
function SubSchemeReportDivisionAsOn({report,fromDate,toDate}) {
  ...
  return (
    ...
    <table className="f6 w-100 center mb3 ba" cellSpacing="0">
      <tr style={{"borderWidth":"1px", 'borderColor':"#000000", 'borderStyle':'solid', textAlign:"center"}}>
        <td colSpan='15' style={{"borderWidth":"1px", 'borderColor':"#000000", 'borderStyle':'solid', textAlign:"center", fontWeight: 'bold'}}>{`Detailed Report from ${fromDate} to ${toDate}`}</td>
      </tr>
...
export default SubSchemeReportDivisionAsOn