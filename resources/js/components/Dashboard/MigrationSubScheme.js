...
import {miggetSubSchemesReport,miggetSubSchemesHeaderReport} from '../store/subschemes-actions';
...
function MigrationSubScheme() {
  ...
  useEffect(() => {
    dispatch(miggetSubSchemesReport(params.id));
...
export default MigrationSubScheme