...
import {miggetPendingSubSchemesDeptData,migupdateSubSchemeData,migdeleteSubSchemeData} from '../store/subschemes-actions';
...
function AdminPendingSubScheme() {
  ...
  useEffect(() => {
    dispatch(miggetPendingSubSchemesDeptData(params.id))
    return () => {
...
export default AdminPendingSubScheme
