...
function AdminMigrationDivisionSummary({id, name}) {
  ...
  return (<> 
    <div className='mh1 mh4-m mh5-ns br3'>
        ...
        <Link to={`/dashboard/migrationsummarydept/${division.id}/${division.name}`} className='no-underline' style={{ textDecoration: 'none' }}>
...
export default AdminMigrationDivisionSummary