...
function DivisionReportDownload({id, name}) {
  ...
  return (<> 
    <div className='mh1 mh4-m mh5-ns br3'>
        ...
        <Link to={`/dashboard/outcomebudget/${division.id}`} className='no-underline' style={{ textDecoration: 'none' }}>
...
export default DivisionReportDownload