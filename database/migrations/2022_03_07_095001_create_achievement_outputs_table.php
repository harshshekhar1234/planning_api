...
class CreateAchievementOutputsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('achievement_outputs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('achievement_outputs');
    }
}
