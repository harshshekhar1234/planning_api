...
class CreateAchievementOutcomesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('achievement_outcomes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('achievement_outcomes');
    }
}
