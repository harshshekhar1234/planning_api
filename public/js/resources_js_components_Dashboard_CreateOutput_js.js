"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_Dashboard_CreateOutput_js"],{

/***/ "./resources/js/components/Dashboard/CreateOutput.js":
/*!***********************************************************!*\
  !*** ./resources/js/components/Dashboard/CreateOutput.js ***!
  \***********************************************************/
...
/* harmony import */ var _store_output_actions__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../store/output-actions */ "./resources/js/components/store/output-actions.js");
...
function CreateOutput() {
  ...
  var departments = (0,react_redux__WEBPACK_IMPORTED_MODULE_10__.useSelector)(function (state) {
    return state.departments.departments;
  });
  var divisions = (0,react_redux__WEBPACK_IMPORTED_MODULE_10__.useSelector)(function (state) {
    return state.divisions.divisions;
  });
  var searchScheme = (0,react_redux__WEBPACK_IMPORTED_MODULE_10__.useSelector)(function (state) {
    return state.schemes.schemeSearch;
  });
  var searchSubScheme = (0,react_redux__WEBPACK_IMPORTED_MODULE_10__.useSelector)(function (state) {
    return state.subschemes.subschemeSearch;
  });
  var schemeStateName = (0,react_redux__WEBPACK_IMPORTED_MODULE_10__.useSelector)(function (state) {
    return state.schemes.schemeStateName;
  });
  var schemeCenterName = (0,react_redux__WEBPACK_IMPORTED_MODULE_10__.useSelector)(function (state) {
    return state.schemes.schemeCenterName;
  });
  var schemeStateCode = (0,react_redux__WEBPACK_IMPORTED_MODULE_10__.useSelector)(function (state) {
    return state.schemes.schemeStateCode;
  });
  var schemeCenterCode = (0,react_redux__WEBPACK_IMPORTED_MODULE_10__.useSelector)(function (state) {
    return state.schemes.schemeCenterCode;
  });
  var schemeSearchMessage = (0,react_redux__WEBPACK_IMPORTED_MODULE_10__.useSelector)(function (state) {
    return state.schemes.searchMessage;
  });
  var subschemename = (0,react_redux__WEBPACK_IMPORTED_MODULE_10__.useSelector)(function (state) {
    return state.subschemes.subschemename;
  });
  var subschemecode = (0,react_redux__WEBPACK_IMPORTED_MODULE_10__.useSelector)(function (state) {
    return state.subschemes.subschemecode;
  });
  var subschemesearchmessage = (0,react_redux__WEBPACK_IMPORTED_MODULE_10__.useSelector)(function (state) {
    return state.subschemes.searchMessage;
  });
  var outputmessage = (0,react_redux__WEBPACK_IMPORTED_MODULE_10__.useSelector)(function (state) {
    return state.outputs.message;
  });
  var outputname = (0,react_redux__WEBPACK_IMPORTED_MODULE_10__.useSelector)(function (state) {
    return state.outputs.outputName;
  });
  ...
  var _useState5 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('statename'),
      _useState6 = _slicedToArray(_useState5, 2),
      schemeSearchType = _useState6[0],
      setSchemeSearchType = _useState6[1];

  var _useState7 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('name'),
      _useState8 = _slicedToArray(_useState7, 2),
      subschemeSearchType = _useState8[0],
      setSubSchemeSearchType = _useState8[1];

  var _useState9 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({}),
      _useState10 = _slicedToArray(_useState9, 2),
      schemeSearchResult = _useState10[0],
      setSchemeSearchResult = _useState10[1];

  var _useState11 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({}),
      _useState12 = _slicedToArray(_useState11, 2),
      subSchemeSearchResult = _useState12[0],
      setSubSchemeSearchResult = _useState12[1];
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    return function () {
      ...
      dispatch(_store_outputSlice__WEBPACK_IMPORTED_MODULE_7__.outputsActions.setMessage({
        message: ''
      }));
      dispatch(_store_outputSlice__WEBPACK_IMPORTED_MODULE_7__.outputsActions.setOutputName({
        outputName: ''
      }));
    };
  }, []);
  ...
  var onSubmitOutput = function onSubmitOutput() {
    if (divisionId === '') {
      return dispatch(_store_outputSlice__WEBPACK_IMPORTED_MODULE_7__.outputsActions.setMessage({
    ...
    if (outputname === '') {
      return dispatch(_store_outputSlice__WEBPACK_IMPORTED_MODULE_7__.outputsActions.setMessage({
        message: 'Please Enter Output Name'
      }));
    }

    dispatch((0,_store_output_actions__WEBPACK_IMPORTED_MODULE_9__.storeOutputData)(departmentId, divisionId, schemeSearchResult.id, subSchemeSearchResult.id, outputname));
    setDepartmentId('');
    setDivisionId('');
    setSchemeSearchType('statename');
    setSchemeSearchResult({});
  ...
  var handleOutputNameChange = function handleOutputNameChange(event) {
    dispatch(_store_outputSlice__WEBPACK_IMPORTED_MODULE_7__.outputsActions.setMessage({
      message: ''
    }));
    dispatch(_store_outputSlice__WEBPACK_IMPORTED_MODULE_7__.outputsActions.setOutputName({
  ...
  var handleSearchSubSchemeName = function handleSearchSubSchemeName(event) {
    ...
    {
      event.target.value !== '' ? dispatch((0,_store_subschemes_actions__WEBPACK_IMPORTED_MODULE_8__.searchSubSchemesName)(event.target.value, schemeSearchResult.id)) : null;
    }
  };
  ...
  var handleSearchSubSchemeCode = function handleSearchSubSchemeCode(event) {
    ...
    {
      event.target.value !== '' ? dispatch((0,_store_subschemes_actions__WEBPACK_IMPORTED_MODULE_8__.searchSubSchemesCode)(event.target.value, schemeSearchResult.id)) : null;
    }
  };
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)("h1", {
      className: "b",
      children: "Create Output for Sub Scheme"
    ...
    }), schemeSearchType === 'statename' ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)("div", {
      className: "pa4 black-80",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)("label", {
    ...
    }) : null, schemeSearchType === 'centername' ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)("div", {
      className: "pa4 black-80",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)("label", {
        htmlFor: "exampleDataList",
        className: "f6 b db mb2",
    ...
    }) : null, schemeSearchType === 'statecode' ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)("div", {
      className: "pa4 black-80",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)("label", {
        htmlFor: "exampleDataList",
        className: "f6 b db mb2",
    ...
    }) : null, schemeSearchType === 'centercode' ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)("div", {
      className: "pa4 black-80",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)("label", {
        htmlFor: "exampleDataList",
        className: "f6 b db mb2",
    ...
    }) : null, schemeSearchMessage !== "" && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)("div", {
    ...
    }), subschemeSearchType === 'name' ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)("div", {
      className: "pa4 black-80",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)("label", {
        htmlFor: "exampleDataList",
        className: "f6 b db mb2",
    ...
    }) : null, subschemeSearchType === 'code' ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)("div", {
      className: "pa4 black-80",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)("label", {
        htmlFor: "exampleDataList",
        className: "f6 b db mb2",
    ...
    }) : null, subschemesearchmessage !== "" && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)("div", {
      className: "flex items-center justify-center pa2 ml4 bg-light-red w-60 navy br2 shadow-2",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)("svg", {
        className: "w1",
        "data-icon": "info",
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)("label", {
        htmlFor: "name",
        className: "f6 b db mb2",
        children: "Please Enter Output Name"
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)("input", {
        id: "name",
        className: "ba b--black-60 pa2 mb2 db w-100 bg-transparent br2 shadow-1",
        type: "text",
        ...
        className: "f6 black-60 db mb2",
        children: "Helper text for the form control."
      }), outputmessage !== '' && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)("p", {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CreateOutput);
