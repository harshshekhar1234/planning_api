"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_Dashboard_CreateOutcome_js"],{

/***/ "./resources/js/components/Dashboard/CreateOutcome.js":
/*!************************************************************!*\
  !*** ./resources/js/components/Dashboard/CreateOutcome.js ***!
  \************************************************************/
...
/* harmony import */ var _store_outcome_actions__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../store/outcome-actions */ "./resources/js/components/store/outcome-actions.js");
...
function CreateOutcome() {
  ...
  var outcomemessage = (0,react_redux__WEBPACK_IMPORTED_MODULE_10__.useSelector)(function (state) {
    return state.outcomes.message;
  });
  var outcomename = (0,react_redux__WEBPACK_IMPORTED_MODULE_10__.useSelector)(function (state) {
    return state.outcomes.outcomeName;
  });
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    return function () {
      ...
      dispatch(_store_outcomeSlice__WEBPACK_IMPORTED_MODULE_7__.outcomesActions.setMessage({
        message: ''
      }));
      dispatch(_store_outcomeSlice__WEBPACK_IMPORTED_MODULE_7__.outcomesActions.setOutcomeName({
        outcomeName: ''
      }));
    };
  }, []);
  ...
  var onSubmitOutcome = function onSubmitOutcome() {
    if (divisionId === '') {
      return dispatch(_store_outcomeSlice__WEBPACK_IMPORTED_MODULE_7__.outcomesActions.setMessage({
    ...
    if (outcomename === '') {
      return dispatch(_store_outcomeSlice__WEBPACK_IMPORTED_MODULE_7__.outcomesActions.setMessage({
        message: 'Please Enter Outcome Name'
      }));
    }

    dispatch((0,_store_outcome_actions__WEBPACK_IMPORTED_MODULE_9__.storeOutcomeData)(departmentId, divisionId, schemeSearchResult.id, subSchemeSearchResult.id, outcomename));
  };

  var handleOutcomeNameChange = function handleOutcomeNameChange(event) {
    dispatch(_store_outcomeSlice__WEBPACK_IMPORTED_MODULE_7__.outcomesActions.setMessage({
      message: ''
    }));
    dispatch(_store_outcomeSlice__WEBPACK_IMPORTED_MODULE_7__.outcomesActions.setOutcomeName({
      outcomeName: event.target.value
    }));
  };
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)("h1", {
      className: "b",
      children: "Create Outcome for Sub Scheme"
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)("label", {
        htmlFor: "name",
        className: "f6 b db mb2",
        children: "Please Enter Outcome Name"
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)("input", {
        id: "name",
        className: "ba b--black-60 pa2 mb2 db w-100 bg-transparent br2 shadow-1",
        type: "text",
        ...
        className: "f6 black-60 db mb2",
        children: "Helper text for the form control."
      }), outcomemessage !== '' && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)("p", {
        ...
        children: "Create Outcome"
      })]
    })]
  });
}

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CreateOutcome);
