"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_Dashboard_CreateOutputIndicator_js"],{

/***/ "./resources/js/components/Dashboard/CreateOutputIndicator.js":
/*!********************************************************************!*\
  !*** ./resources/js/components/Dashboard/CreateOutputIndicator.js ***!
  \********************************************************************/
...
/* harmony import */ var _store_outputSlice__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../store/outputSlice */ "./resources/js/components/store/outputSlice.js");
/* harmony import */ var _store_outputindicatorSlice__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../store/outputindicatorSlice */ "./resources/js/components/store/outputindicatorSlice.js");
...
/* harmony import */ var _store_output_actions__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../store/output-actions */ "./resources/js/components/store/output-actions.js");
/* harmony import */ var _store_outputindicator_actions__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../store/outputindicator-actions */ "./resources/js/components/store/outputindicator-actions.js");
...
function CreateOutputIndicator() {
  ...
  var outputsearch = (0,react_redux__WEBPACK_IMPORTED_MODULE_12__.useSelector)(function (state) {
    return state.outputs.searchOutput;
  });
  ...
  var outputsearchmessage = (0,react_redux__WEBPACK_IMPORTED_MODULE_12__.useSelector)(function (state) {
    return state.outputs.searchMessage;
  });
  var outputindicatorname = (0,react_redux__WEBPACK_IMPORTED_MODULE_12__.useSelector)(function (state) {
    return state.outputindicator.outputindicatorName;
  });
  var outputindicatormessage = (0,react_redux__WEBPACK_IMPORTED_MODULE_12__.useSelector)(function (state) {
    return state.outputindicator.message;
  });
  ...
  var _useState5 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
      ...
      outputId = _useState6[0],
      setOutputId = _useState6[1];
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    return function () {
      ...
      dispatch(_store_outputSlice__WEBPACK_IMPORTED_MODULE_7__.outputsActions.setOutputSearchMessage({
        searchMessage: ''
      }));
      dispatch(_store_outputSlice__WEBPACK_IMPORTED_MODULE_7__.outputsActions.setOutputSearch({
        searchOutput: []
      }));
      dispatch(_store_outputindicatorSlice__WEBPACK_IMPORTED_MODULE_8__.outputindicatorActions.setOutputIndicatorName({
        outputindicatorName: ''
      }));
      dispatch(_store_outputindicatorSlice__WEBPACK_IMPORTED_MODULE_8__.outputindicatorActions.setMessage({
        message: ''
      }));
    };
  }, []);
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    if (Object.keys(subSchemeSearchResult).length !== 0) {
      dispatch((0,_store_output_actions__WEBPACK_IMPORTED_MODULE_10__.getSearchOutputData)(subSchemeSearchResult.id));
    }
  ...
  var handleOutputChange = function handleOutputChange(event) {
    dispatch(_store_outputSlice__WEBPACK_IMPORTED_MODULE_7__.outputsActions.setOutputSearchMessage({
      searchMessage: ''
    }));
    dispatch(_store_outputindicatorSlice__WEBPACK_IMPORTED_MODULE_8__.outputindicatorActions.setMessage({
  ...
  var onSubmitOutputIndicator = function onSubmitOutputIndicator() {
    if (divisionId === '') {
      return dispatch(_store_outputindicatorSlice__WEBPACK_IMPORTED_MODULE_8__.outputindicatorActions.setMessage({
    ...
    if (outputindicatorname === '') {
      return dispatch(_store_outputindicatorSlice__WEBPACK_IMPORTED_MODULE_8__.outputindicatorActions.setMessage({
        message: 'Please Enter Output Indicator'
      }));
    }

    dispatch((0,_store_outputindicator_actions__WEBPACK_IMPORTED_MODULE_11__.storeOutputIndicatorData)(departmentId, divisionId, schemeSearchResult.id, subSchemeSearchResult.id, outputId, outputindicatorname));
  };

  var handleOutputIndicatorNameChange = function handleOutputIndicatorNameChange(event) {
    dispatch(_store_outputindicatorSlice__WEBPACK_IMPORTED_MODULE_8__.outputindicatorActions.setMessage({
      message: ''
    }));
    dispatch(_store_outputindicatorSlice__WEBPACK_IMPORTED_MODULE_8__.outputindicatorActions.setOutputIndicatorName({
      outputindicatorName: event.target.value
    }));
  };
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("h1", {
      className: "b",
      children: "Create Output Indicator"
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("p", {
        className: "f6 fw6 db black link dim pointer ba b--dark-green pa2 shadow-2",
      ...
      className: "pa4 lh-copy flex flex-wrap justify-around",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("p", {
        className: "f6 fw6 db black link dim pointer ba b--dark-green pa2 shadow-2 br2",
        onClick: function onClick() {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("label", {
        ...
        className: "overflow-visible pointer bg-transparent w-100",
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("label", {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("option", {
            value: "default",
            children: "Select the output"
          }), outputsearch.map(function (output) {
            return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("option", {
              value: output.id,
      ...
      }), outputsearchmessage !== "" && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("div", {
        className: "flex items-center justify-center pa2 ml4 bg-light-red w-60 navy br2 shadow-2",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("svg", {
          className: "w1",
          "data-icon": "info",
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("label", {
        htmlFor: "name",
        className: "f6 b db mb2",
        children: "Please Enter Output Indicator"
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("input", {
        id: "name",
        className: "ba b--black-60 pa2 mb2 db w-100 bg-transparent br2 shadow-1",
        type: "text",
        "aria-describedby": "name-desc",
        onChange: handleOutputIndicatorNameChange,
        value: outputindicatorname
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("small", {
        id: "name-desc",
        className: "f6 black-60 db mb2",
        children: "Helper text for the form control."
      }), outputindicatormessage !== '' && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("p", {
        className: "f6 ph3 pv2 mb2 mt2 black w-100 tc pointer b ba b--black-40",
        children: outputindicatormessage
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("p", {
        className: "f6 link dim br3 ph3 pv2 mb2 dib mt2 white bg-dark-green w5 tc pointer shadow-3",
        onClick: onSubmitOutputIndicator,
        children: "Create Output Indicator"
      })]
    })]
  });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CreateOutputIndicator);
...
/***/ "./resources/js/components/store/output-actions.js":
/*!*********************************************************!*\
  !*** ./resources/js/components/store/output-actions.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getOutputsData": () => (/* binding */ getOutputsData),
/* harmony export */   "getSearchOutputData": () => (/* binding */ getSearchOutputData),
/* harmony export */   "miggetSearchOutputData": () => (/* binding */ miggetSearchOutputData),
/* harmony export */   "storeOutputData": () => (/* binding */ storeOutputData),
/* harmony export */   "updateOutputData": () => (/* binding */ updateOutputData),
/* harmony export */   "migupdateOutputData": () => (/* binding */ migupdateOutputData),
/* harmony export */   "deleteOutputData": () => (/* binding */ deleteOutputData),
/* harmony export */   "migdeleteOutputData": () => (/* binding */ migdeleteOutputData)
/* harmony export */ });
...
/* harmony import */ var _outputSlice__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./outputSlice */ "./resources/js/components/store/outputSlice.js");
...
var getOutputsData = function getOutputsData(id) {
  return function (dispatch) {
    fetch("".concat(_configuration__WEBPACK_IMPORTED_MODULE_3__.laravel_api, "outputs/").concat(id), {
      method: 'GET',
      headers: {
        'Authorization': "Bearer ".concat(localStorage.getItem('access_token'))
      }
      ...
      if (res.length !== 0) {
        dispatch(_outputSlice__WEBPACK_IMPORTED_MODULE_2__.outputsActions.setOutputs({
          outputs: res
        }));
      } else {
        ...
        dispatch(_outputSlice__WEBPACK_IMPORTED_MODULE_2__.outputsActions.setMessage({
          message: 'Sorry something went wrong!!'
        }));
      }
    })["catch"](function (err) {
...
var getSearchOutputData = function getSearchOutputData(id) {
  return function (dispatch) {
    fetch("".concat(_configuration__WEBPACK_IMPORTED_MODULE_3__.laravel_api, "outputs/").concat(id), {
      method: 'GET',
      headers: {
      ...
      if (res.length !== 0) {
        dispatch(_outputSlice__WEBPACK_IMPORTED_MODULE_2__.outputsActions.setOutputUpdate({
          updateOutput: false
        }));
        dispatch(_outputSlice__WEBPACK_IMPORTED_MODULE_2__.outputsActions.setOutputSearch({
          searchOutput: res
        }));
      } else {
        dispatch(_outputSlice__WEBPACK_IMPORTED_MODULE_2__.outputsActions.setOutputUpdate({
        ...
        dispatch(_outputSlice__WEBPACK_IMPORTED_MODULE_2__.outputsActions.setOutputSearchMessage({
...
var miggetSearchOutputData = function miggetSearchOutputData(id) {
  return function (dispatch) {
    fetch("".concat(_configuration__WEBPACK_IMPORTED_MODULE_3__.laravel_api, "mig_outputs/").concat(id), {
      method: 'GET',
      headers: {
        'Authorization': "Bearer ".concat(localStorage.getItem('access_token'))
      }
...
var storeOutputData = function storeOutputData(departmentId, divisionId, schemeId, subschemeId, name) {
  return function (dispatch) {
    fetch("".concat(_configuration__WEBPACK_IMPORTED_MODULE_3__.laravel_api, "output"), {
      method: 'post',
      headers: {
        'Authorization': "Bearer ".concat(localStorage.getItem('access_token')),
      ...
      if (res.status === 200) {
        ...
        dispatch(_outputSlice__WEBPACK_IMPORTED_MODULE_2__.outputsActions.setOutputName({
          outputName: ''
        }));
      } else {
        dispatch(_errorSlice__WEBPACK_IMPORTED_MODULE_4__.errorActions.setError({
...
var updateOutputData = function updateOutputData(id, output) {
  return function (dispatch) {
    fetch("".concat(_configuration__WEBPACK_IMPORTED_MODULE_3__.laravel_api, "output/update/").concat(id), {
      method: 'post',
      headers: {
        'Authorization': "Bearer ".concat(localStorage.getItem('access_token')),
        'Content-Type': 'application/json'
...
var migupdateOutputData = function migupdateOutputData(id, output) {
  return function (dispatch) {
    fetch("".concat(_configuration__WEBPACK_IMPORTED_MODULE_3__.laravel_api, "mig_output/update/").concat(id), {
      method: 'post',
      headers: {
        'Authorization': "Bearer ".concat(localStorage.getItem('access_token')),
        'Content-Type': 'application/json'
...
var deleteOutputData = function deleteOutputData(id) {
  return function (dispatch) {
    fetch("".concat(_configuration__WEBPACK_IMPORTED_MODULE_3__.laravel_api, "output/delete/").concat(id), {
      method: 'DELETE',
      headers: {
        'Authorization': "Bearer ".concat(localStorage.getItem('access_token'))
      }
      ...
      if (res.status === 200) {
        dispatch(_outputSlice__WEBPACK_IMPORTED_MODULE_2__.outputsActions.setOutputDeleteSuccess({
          outputDeleteSuccess: true
        }));
        dispatch(_outputSlice__WEBPACK_IMPORTED_MODULE_2__.outputsActions.setOutputUpdate({
          updateOutput: true
        }));
...
var migdeleteOutputData = function migdeleteOutputData(id) {
  return function (dispatch) {
    fetch("".concat(_configuration__WEBPACK_IMPORTED_MODULE_3__.laravel_api, "mig_output/delete/").concat(id), {
      method: 'DELETE',
      headers: {
        'Authorization': "Bearer ".concat(localStorage.getItem('access_token'))
      }
...
/***/ "./resources/js/components/store/outputindicator-actions.js":
/*!******************************************************************!*\
  !*** ./resources/js/components/store/outputindicator-actions.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getOutputIndicatorsData": () => (/* binding */ getOutputIndicatorsData),
/* harmony export */   "miggetOutputIndicatorsData": () => (/* binding */ miggetOutputIndicatorsData),
/* harmony export */   "storeOutputIndicatorData": () => (/* binding */ storeOutputIndicatorData),
/* harmony export */   "deleteOutputIndicatorData": () => (/* binding */ deleteOutputIndicatorData),
/* harmony export */   "migdeleteOutputIndicatorData": () => (/* binding */ migdeleteOutputIndicatorData)
/* harmony export */ });
/* harmony import */ var _subschemesSlice__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./subschemesSlice */ "./resources/js/components/store/subschemesSlice.js");
/* harmony import */ var _schemesSlice__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./schemesSlice */ "./resources/js/components/store/schemesSlice.js");
/* harmony import */ var _outputSlice__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./outputSlice */ "./resources/js/components/store/outputSlice.js");
/* harmony import */ var _outputindicatorSlice__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./outputindicatorSlice */ "./resources/js/components/store/outputindicatorSlice.js");
...
var getOutputIndicatorsData = function getOutputIndicatorsData(id) {
  return function (dispatch) {
    fetch("".concat(_configuration__WEBPACK_IMPORTED_MODULE_4__.laravel_api, "outputindicator/").concat(id), {
      method: 'GET',
      headers: {
        'Authorization': "Bearer ".concat(localStorage.getItem('access_token'))
      }
      ...
      if (res.length !== 0) {
        dispatch(_outputindicatorSlice__WEBPACK_IMPORTED_MODULE_3__.outputindicatorActions.setOutputIndicatorSearch({
          searchOutputIndicator: res
        }));
      } else {
        dispatch(_errorSlice__WEBPACK_IMPORTED_MODULE_5__.errorActions.setError({
          error: true
        }));
        dispatch(_outputindicatorSlice__WEBPACK_IMPORTED_MODULE_3__.outputindicatorActions.setOutputIndicatorSearchMessage({
          searchMessage: 'Sorry something went wrong!!'
        }));
      }
    })["catch"](function (err) {
...
var miggetOutputIndicatorsData = function miggetOutputIndicatorsData(id) {
  return function (dispatch) {
    fetch("".concat(_configuration__WEBPACK_IMPORTED_MODULE_4__.laravel_api, "mig_outputindicator/").concat(id), {
      method: 'GET',
      headers: {
        'Authorization': "Bearer ".concat(localStorage.getItem('access_token'))
      }
...
var storeOutputIndicatorData = function storeOutputIndicatorData(departmentId, divisionId, schemeId, subschemeId, outputId, name) {
  return function (dispatch) {
    fetch("".concat(_configuration__WEBPACK_IMPORTED_MODULE_4__.laravel_api, "outputindicator"), {
      method: 'post',
      headers: {
        'Authorization': "Bearer ".concat(localStorage.getItem('access_token')),
        'Content-Type': 'application/json'
      ...
      if (res.status === 200) {
        ...
        dispatch(_outputindicatorSlice__WEBPACK_IMPORTED_MODULE_3__.outputindicatorActions.setMessage({
          message: 'Output Indicator created successfully'
        }));
        dispatch(_outputindicatorSlice__WEBPACK_IMPORTED_MODULE_3__.outputindicatorActions.setOutputIndicatorName({
          outputindicatorName: ''
        }));
        dispatch(_outputSlice__WEBPACK_IMPORTED_MODULE_2__.outputsActions.setOutputSearch({
          searchOutput: []
...
var deleteOutputIndicatorData = function deleteOutputIndicatorData(id) {
  return function (dispatch) {
    fetch("".concat(_configuration__WEBPACK_IMPORTED_MODULE_4__.laravel_api, "outputindicator/delete/").concat(id), {
      method: 'DELETE',
      headers: {
        'Authorization': "Bearer ".concat(localStorage.getItem('access_token'))
      }
      ...
      if (res.status === 200) {
        dispatch(_outputindicatorSlice__WEBPACK_IMPORTED_MODULE_3__.outputindicatorActions.setOutputIndicatorDeleteSuccess({
          outputIndicatorDeleteSuccess: true
        }));
      } else {
        dispatch(_errorSlice__WEBPACK_IMPORTED_MODULE_5__.errorActions.setError({
          error: true
...
var migdeleteOutputIndicatorData = function migdeleteOutputIndicatorData(id) {
  return function (dispatch) {
    fetch("".concat(_configuration__WEBPACK_IMPORTED_MODULE_4__.laravel_api, "mig_outputindicator/delete/").concat(id), {
      method: 'DELETE',
      headers: {
        'Authorization': "Bearer ".concat(localStorage.getItem('access_token'))
      }
