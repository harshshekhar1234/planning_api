"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_Dashboard_MigrationDivisionReportDownload_js"],{

/***/ "./resources/js/components/Dashboard/MigrationDivisionReportDownload.js":
/*!******************************************************************************!*\
  !*** ./resources/js/components/Dashboard/MigrationDivisionReportDownload.js ***!
  \******************************************************************************/
...
function MigrationDivisionReportDownload(_ref) {
  var id = _ref.id,
      name = _ref.name;
      ...
      children: divisions.map(function (division) {
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("main", {
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(react_router_dom__WEBPACK_IMPORTED_MODULE_8__.Link, {
            to: "/dashboard/migrationoutcomebudget/".concat(division.id),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MigrationDivisionReportDownload);
